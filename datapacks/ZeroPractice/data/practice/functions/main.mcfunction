# resets
execute as @a[scores={reset=1..},tag=inSetup] in minecraft:the_end run function practice:reset
execute as @a[scores={reset_drop=1..},tag=inSetup] in minecraft:the_end run function practice:reset
...
# kill or reset out of map player
...
# repair lobby
scoreboard players enable @a repairzero
execute if entity @a[scores={repairzero=1..}] in minecraft:the_end run function practice:level/repair
